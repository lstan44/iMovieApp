...
import com.stanleylalanne.imovieapp.api.model.Genre;
import com.stanleylalanne.imovieapp.api.model.Images;
import com.stanleylalanne.imovieapp.api.model.Movie;
import com.stanleylalanne.imovieapp.api.model.GetLanguage;
...
public class DetailActivity extends AppCompatActivity implements DetailContract.View {
    ...
    private String getLanguages(Movie movie) {
        ...
        for (int i = 0; i < movie.getLanguages.size(); i++) {
            GetLanguage language = movie.getLanguages.get(i);
    ...
    void onBookButtonClick() {
        Toast.makeText(this,"Bookmark Feature not yet implemented",Toast.LENGTH_SHORT).show();
    }
